...
const allItems: CommunityItem[] = [
  ...
  },
  {
    id: "case-445",
    type: "Video",
    title: "Cooking tutorial segment",
    excerpt: "Hand movements are slightly unnatural, shadows don't match lighting.",
    crowdScore: "71% AI",
    aiScore: "68% AI",
    votes: 156,
    actualAnswer: "ai",
  },
  {
    ...
    excerpt: "Very formal tone with perfect grammar throughout.",
    crowdScore: "45% AI",
    aiScore: "52% AI",
    votes: 267,
    actualAnswer: "real",
  },
  {
    ...
    excerpt: "Perfect symmetry and uniform color gradients.",
    crowdScore: "89% AI",
    aiScore: "91% AI",
    votes: 445,
    actualAnswer: "ai",
  },
  {
    ...
    excerpt: "Casual language with emojis and personal opinions.",
    crowdScore: "12% AI",
    aiScore: "15% AI",
    votes: 78,
    actualAnswer: "real",
...
export default function CommunityPage() {
  const [items, setItems] = useState<CommunityItem[]>(allItems);
    ...
    <div className="min-h-screen pb-16 text-primary">
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 pb-12 pt-10 lg:px-10">
        ...
        <section>
          <div className="glass-card flex flex-col gap-6 p-6 md:p-8">
            ...
            <h2 className="text-3xl font-semibold leading-tight text-primary md:text-4xl">
              Help train our AI by voting on real submissions
            </h2>
            <p className="text-sm text-secondary">
              Every vote helps improve our detection accuracy. Test your skills
              and see how well you can spot AI-generated content.
            </p>
          </div>
        </section>
        ...
        <div className="flex items-center justify-between">
          {stats.total > 0 && (
            <div className="glass-surface flex items-center gap-4 px-6 py-3 text-sm">
              <div className="flex items-center gap-2">
                <span className="text-tertiary">Your Score:</span>
